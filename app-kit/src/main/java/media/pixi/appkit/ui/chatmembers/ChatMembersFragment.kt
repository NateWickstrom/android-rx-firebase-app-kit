...
class ChatMembersFragment @Inject constructor(): DaggerFragment(), ChatMembersContract.View {
    ...
    private var adapter: ChatMembersAdapter? = null

    lateinit var presenter: ChatMembersContract.Presenter
    ...
    override fun showNoResults(show: Boolean) {
        empty_message.setText("Opps, failed to find chat member")
