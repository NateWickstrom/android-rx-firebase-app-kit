...
import kotlinx.android.synthetic.main.appkit__fragment_password_update.view.*
...
class PasswordUpdateFragment @Inject constructor(): DaggerFragment(), PasswordUpdateContract.View {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        viewOfLayout = inflater.inflate(R.layout.appkit__fragment_password_update, container, false)
