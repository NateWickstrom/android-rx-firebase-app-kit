...
class MessageVideoViewHolder (itemView: View): MessageViewHolder(itemView) {
    ...
    private lateinit var message: VideoMessage

    override fun bind(messageItem: MessageListItem, showTimeStamp: Boolean) {
        this.message = messageItem.message as VideoMessage
